...
},
{
  ...
  name: 'Óptica Malavé',
  shortDescription:
    'E-commerce de lentes con catálogo organizado por categorías y enfoque en conversión.',
  description:
    'Desarrollo de tienda online para óptica, enfocada en la venta de lentes con navegación clara por categorías como dama, caballeros y niños. El proyecto prioriza la experiencia de usuario, presentación de productos y facilidad de compra.',
  category: 'wordpress',
  ...
  highlights: [
    ...
    'Secciones promocionales y destacadas',
  ],
  year: 2026,
},
{
  ...
  shortDescription:
    'Landing de reclutamiento para captación de corredores inmobiliarios.',
  description:
    'Desarrollo de landing page enfocada en la captación de nuevos corredores inmobiliarios. El proyecto está orientado a conversión, con estructura clara de beneficios, requisitos y formulario de contacto directo.',
  category: 'wordpress',
  ...
  featured: false,
  highlights: [
    'Estructura optimizada para captación de leads',
    'Sección clara de beneficios y requisitos',
...
},
{
  ...
  shortDescription:
    'Landing institucional para leilões online y presenciales.',
  description:
    'Desarrollo de página institucional para empresa de leilões, explicando el proceso de participación tanto online como presencial. El enfoque está en claridad, confianza y guía paso a paso para el usuario.',
  category: 'wordpress',
  stack: ['WordPress', 'Elementor', 'HTML', 'CSS'],
  ...
  featured: false,
  highlights: [
    'Explicación clara del proceso de leilão',
    'Secciones paso a paso para el usuario',
    'Diseño institucional enfocado en confianza',
...
},
{
  ...
  shortDescription:
    'Website corporativo para servicios contables con enfoque en confianza y autoridad.',
  description:
    'Desarrollo de sitio web corporativo para empresa de contabilidad, enfocado en la presentación de servicios, soluciones empresariales y captación de clientes. Se priorizó una estructura clara y profesional.',
  category: 'wordpress',
  stack: ['WordPress', 'Elementor', 'HTML', 'CSS'],
  ...
  featured: false,
  highlights: [
    'Presentación estructurada de servicios contables',
    'Diseño profesional y corporativo',
    'Sección de soluciones empresariales',
    'Enfoque en generación de confianza',
  ],
  year: 2026,
},
{
  ...
  name: 'Galvão 75 Anos',
  shortDescription:
    'Landing institucional con storytelling de marca y línea de tiempo.',
  description:
    'Desarrollo de landing page conmemorativa para los 75 años de la empresa Galvão, enfocada en storytelling, historia de marca y evolución a lo largo del tiempo. El diseño combina contenido visual y narrativa.',
  category: 'wordpress',
  stack: ['WordPress', 'Elementor', 'HTML', 'CSS'],
  ...
  featured: true,
  highlights: [
    'Narrativa visual con línea de tiempo',
    'Diseño enfocado en branding',
    'Secciones históricas bien estructuradas',
    'Uso de storytelling para conectar con el usuario',
  ],
  year: 2026,
},
{
  ...
  shortDescription:
    'Website institucional para escritório de abogados con enfoque estratégico.',
  description:
    'Desarrollo de sitio web para firma de abogados, con enfoque en posicionamiento profesional, presentación de áreas de actuación y generación de confianza. Diseño limpio y orientado a servicios jurídicos.',
  category: 'wordpress',
  stack: ['WordPress', 'Elementor', 'HTML', 'CSS'],
  ...
  featured: false,
  highlights: [
    'Presentación clara de áreas legales',
    'Diseño institucional y profesional',
    'Enfoque en credibilidad',
    'Estructura orientada a servicios',
  ],
  year: 2026,
},
